 ...
 * (@jatin-yadav05). Six stacked layers, none of them an image file:
 *
 *   1. dotted lattice     — two offset radial-gradients
 *   2. ambient blooms     — slow, blurred radials that breathe
 *   3. vignette           — pulls the eye to the centre
 *   4. sweep highlight    — a diagonal band that crosses on a long cycle
 *   5. edge lighting      — hairlines catching light at the frame
 *   6. horizon glow       — a low warm wash at the base
 *
...
export function HeroBackground() {
  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      {/* 4 — sweep highlight, on a long cycle so it reads as a glint */}
      {reduceMotion ? null : (
        <motion.div
      ...
      {/* 6 — horizon glow, tying the hero into the section beneath it */}
      <div
