 ...
 * `filter: blur()`. So the palette is repeated literally here — this is the one
 * place in the project where the token values are duplicated, and it is
 * unavoidable.
 */
...
export default function OpengraphImage() {
  return new ImageResponse(
    (
      ...
      >
        {/* Champagne bloom, top right. A radial gradient stands in for the
            blurred radial used on the site itself. */}
        <div
          style={{
            position: "absolute",
            top: -220,
            ...
            borderRadius: 999,
            background:
              "radial-gradient(circle, rgba(214,183,124,0.20) 0%, rgba(214,183,124,0) 70%)",
            display: "flex",
          }}
        />
        ...
        <div
          style={{
            ...
            height: 3,
            background:
              "linear-gradient(to right, #d6b77c, rgba(214,183,124,0))",
            display: "flex",
          }}
        />
